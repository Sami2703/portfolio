...
const About = () => {
  ...
  if (imageRef.current) {
    ...
    { icon: <FaJs />, style: "top-15 left-[-10] text-yellow-400" },
    ...
    { icon: <SiNextdotjs />, style: "bottom-[-4] left-32 text-white-300" },
    ];
  return (
    <div
...
dark:text-white
flex items-center
px-4 sm:px-6 md:px-10 lg:px-16 xl:px-24 py-12 sm:py-16 md:py-20
"
>
...
>
        ...
        {/* LEFT */}
          ...
          <p className="text-gray-700 dark:text-gray-300 leading-8 text-[15px] md:text-[16px]">
            ...
            Experienced in working within Agile teams using Jira, Git/GitHub, and CI/CD practices, while also mentoring junior developers, interns, conducting code reviews, and collaborating with cross-functional teams to deliver high-quality solutions. Passionate about clean, maintainable code, continuous learning, and adapting to modern technologies to build impactful digital projects.
          </p>
...
dark:border-white/10
                ...
                <p className="text-sm sm:text-base text-gray-800 dark:text-white leading-5 break-words">{stat.label}</p>
              </div>
            ))}
          </div>
        </motion.div>
