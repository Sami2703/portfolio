...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-900 text-white py-12 relative overflow-hidden">
      ...
      {/* Background Gradient */}
      <div className="absolute inset-0 bg-gradient-to-r from-pink-900/20 to-cyan-900/20"></div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-10 mb-10">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400 leading-relaxed p-5">
          ...
          <div className="space-y-2 mx-16">
            ...
            <div className="space-y-3 p-5">
              ...
              <button
                ...
                className="block text-gray-400 hover:text-pink-400 transition duration-300"
              >
                About
              </button>
          ...
          <div className="space-y-4 p-5">
            ...
            <div className="space-y-3">
              ...
              <a
                ...
                className="flex items-center gap-3 text-gray-400 hover:text-pink-400 transition duration-300 text-sm"
              >
                <FaEnvelope />
            ...
            <div className="flex gap-4 pt-4">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="p-3 bg-gray-800 rounded-lg text-gray-400 hover:text-pink-400 hover:bg-gray-700 transition duration-300"
              >
                <FaGithub size={18} />
              </a>
        ...
        <div className="border-t border-gray-800 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              onClick={scrollToTop}
              className="p-3 bg-pink-500 rounded-lg text-white hover:bg-pink-600 transition duration-300"
            >
              <FaArrowUp size={14} />
            </button>
